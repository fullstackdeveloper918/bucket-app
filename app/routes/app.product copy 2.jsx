...
// console.log(fetcher?.data?.updatedReview,
//   arrayUpdateReview,"arrayUpdateReview")
...
//          <tbody>
//   {console.log(
//   Array.isArray(arrayUpdateReview)
//     , arrayUpdateReview, "fetcher")}
// {
//   console.log(fetcher?.data?.singleReviews,"fetcher twp")
// }
//   {edit 
//     ? (Array.isArray(arrayUpdateReview) && arrayUpdateReview?.length > 0
//         ? arrayUpdateReview  
//         : fetcher?.data?.singleReviews?.reviews.map((item, index) => (
//           <tr key={index}>
...
//             <td>{item?.comment}</td>
//             <td>
//               {/* Removed the checkbox functionality */}
...
//                     height={14}
//                   />
//                   <span className={edit ? styles.gradientText : ""}>Edit</span>
//                 </button>
//               </div>
//             </td>
...
//                   <span className={styles.gradientText}>import</span>
//                 </button>
//               )}
//             </td>
//           </tr>
